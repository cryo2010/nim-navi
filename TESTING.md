...
| `test_sse.nim` | Sans-io Server-Sent Events parser: fields, multi-line data, comments, CRLF/CR/LF, chunk-boundary splits, BOM, persistent last-id, NUL-id and non-integer-retry rejection |
