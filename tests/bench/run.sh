...
# table; codec/TLS lazy-loader state is {.threadvar.}), so plain orc is thread-safe
# here -- no atomic refcounting needed. --threads:on is still required for the runner.
